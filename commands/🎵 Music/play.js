...
module.exports = {
	...
	category: "🎵 Music",
	aliases: ["p", "run", "start"],
	usage: "play <search_term/url>",

	description: "Plays the requested song. No direct links supported, search as you type on YouTube or Spotify just try to be approx; as search command is not allowed for some reason", //the command description for Slash Command Overview
	cooldown: 2,
