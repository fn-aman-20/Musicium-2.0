...
module.exports = {
  ...
  category: "⚙️ Settings",
  aliases: ["role", "drole", "djrole", "dj-role"],
  usage: "dj add/remove <mention_role>",

  cooldown: 1, //the command cooldown for execution & for helpcmd [OPTIONAL]
  description: "Manage which roles can configure settings!", //the command description for helpcmd [OPTIONAL]
