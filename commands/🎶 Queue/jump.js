...
module.exports = {
	...
	category: "🎶 Queue",
	aliases: ["jump", "jumpto", "skipto"],
	usage: "jump <song_position_in_queue>",

	description: "Jumps to a specific Song in the Queue. Type >queue to get the queue position of a song", //the command description for Slash Command Overview
	cooldown: 10,
			...
			try {
				...
				message.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`👌 **Jumped to the Song position \`${Position}\` in Queue!**`)
